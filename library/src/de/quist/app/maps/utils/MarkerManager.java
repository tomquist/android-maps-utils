 ...
 */
public class MarkerManager implements Map.OnInfoWindowClickListener, Map.OnMarkerClickListener, Map.OnMarkerDragListener, Map.InfoWindowAdapter {
    private final Map mMap;

    private final java.util.Map<String, Collection> mNamedCollections = new HashMap<String, Collection>();
    private final java.util.Map<Marker, Collection> mAllMarkers = new HashMap<Marker, Collection>();
    ...
    public class Collection {
        ...
        private Map.OnMarkerClickListener mMarkerClickListener;
        private Map.OnMarkerDragListener mMarkerDragListener;
        ...
        public void setOnInfoWindowClickListener(Map.OnInfoWindowClickListener infoWindowClickListener) {
            mInfoWindowClickListener = infoWindowClickListener;
        }

        public void setOnMarkerClickListener(Map.OnMarkerClickListener markerClickListener) {
            mMarkerClickListener = markerClickListener;
        }

        public void setOnMarkerDragListener(Map.OnMarkerDragListener markerDragListener) {
            mMarkerDragListener = markerDragListener;
        }

        public void setOnInfoWindowAdapter(Map.InfoWindowAdapter infoWindowAdapter) {
