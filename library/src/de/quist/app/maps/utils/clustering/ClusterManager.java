...
import de.quist.app.maps.utils.clustering.algo.Algorithm;
import de.quist.app.maps.utils.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
import de.quist.app.maps.utils.clustering.algo.PreCachingAlgorithmDecorator;
import de.quist.app.maps.utils.clustering.view.ClusterRenderer;
 ...
 * <p/>
 * ClusterManager should be added to the map as an: <ul> <li>{@link de.quist.app.maps.Map.OnCameraChangeListener}</li>
 * <li>{@link de.quist.app.maps.Map.OnMarkerClickListener}</li> </ul>
 */
public class ClusterManager<T extends ClusterItem> implements Map.OnCameraChangeListener, Map.OnMarkerClickListener, Map.OnInfoWindowClickListener {
    ...
    public ClusterManager(Context context, MapsBinding mapsBinding, Map map) {
        this(context, mapsBinding, map, new MarkerManager(map));
    }

    public ClusterManager(Context context, MapsBinding mapsBinding, Map map, MarkerManager markerManager) {
        mMap = map;
        mMarkerManager = markerManager;
        mClusterMarkers = markerManager.newCollection();
        mMarkers = markerManager.newCollection();
        mRenderer = new DefaultClusterRenderer<T>(context, mapsBinding, map, this);
    ...
    public void onCameraChange(CameraPosition cameraPosition) {
        if (mRenderer instanceof Map.OnCameraChangeListener) {
            ((Map.OnCameraChangeListener) mRenderer).onCameraChange(cameraPosition);
        }
