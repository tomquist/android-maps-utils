...
package de.quist.app.maps.utils.heatmaps;

import android.graphics.Bitmap;
import android.graphics.Color;
import android.support.v4.util.LongSparseArray;

import de.quist.app.maps.utils.geometry.Bounds;
import de.quist.app.maps.utils.geometry.Point;
import de.quist.app.maps.utils.quadtree.PointQuadTree;
...
public class HeatmapTileProvider implements TileProvider {
    ...
    public static class Builder {
        // Required parameter
        private final MapsBinding mapsBinding;
         ...
         */
        public Builder(MapsBinding mapsBinding) {
            this.mapsBinding = mapsBinding;
        }
    ...
    private HeatmapTileProvider(Builder builder) {
        mMapsBinding = builder.mapsBinding;
    ...
    public Tile getTile(int x, int y, int zoom) {
        ...
        return convertBitmap(mMapsBinding, bitmap);
    }
     ...
     * @return the tile
     */
    private static Tile convertBitmap(MapsBinding binding, Bitmap bitmap) {
        // Convert it into byte array (required for tile creation)
        ByteArrayOutputStream stream = new ByteArrayOutputStream();
        bitmap.compress(Bitmap.CompressFormat.PNG, 100, stream);
        byte[] bitmapdata = stream.toByteArray();
        return binding.newTile(TILE_DIM, TILE_DIM, bitmapdata);
    }
